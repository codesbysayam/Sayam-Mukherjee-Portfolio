...
export default function VaultAdminMenuModal({
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-[115] flex items-center justify-center p-4 bg-black/70 backdrop-blur-md animate-fade-in"
      onClick={onClose}
    >
      <div
        onClick={(e) => e.stopPropagation()}
        className={`w-full max-w-sm rounded-2xl border shadow-2xl p-5 sm:p-6 space-y-4 text-left relative overflow-hidden ${
          isLight
